...
4. **Após cada commit**, avaliar se algum documento em `docs/` precisa ser atualizado para refletir a nova realidade. Se sim, incluir no mesmo commit ou num commit imediatamente seguinte.
