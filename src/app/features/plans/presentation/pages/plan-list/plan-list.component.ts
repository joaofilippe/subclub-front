...
@Component({
      ...
      @if (vm.loading()) {
        ...
        @if (viewMode === 'cards') {
          ...
          <div class="simple-list">
            @for (plan of vm.filtered(); track plan.id) {
              <div class="simple-list-item" [class.simple-list-item--inactive]="!plan.active">
                ...
                <div class="simple-list-item__meta">
                  ...
                  <span class="simple-list-item__price">{{ plan.price | currency:'BRL':'symbol':'1.2-2' }}</span>
                </div>
          ...
          <div class="detailed-list">
            <div class="detailed-list-header">
              ...
              <div class="detailed-cell detailed-cell--name">Nome / Descrição</div>
              <div class="detailed-cell detailed-cell--status">Status</div>
              <div class="detailed-cell detailed-cell--price">Preço e Intervalo</div>
              <div class="detailed-cell detailed-cell--actions">Ações</div>
            </div>
            @for (plan of vm.filtered(); track plan.id) {
              <div class="detailed-list-row" [class.detailed-list-row--inactive]="!plan.active">
                <div class="detailed-cell detailed-cell--image">
                  @if (plan.imageUrl) {
                    <img [src]="plan.imageUrl" [alt]="plan.name" class="detailed-image" />
                  } @else {
                ...
                <div class="detailed-cell detailed-cell--price">
                   <div class="detailed-price">{{ plan.price | currency:'BRL':'symbol':'1.2-2' }}</div>
                   <div class="detailed-interval">a cada {{ plan.intervalDays }}d</div>
                </div>
  ...
  styles: [`
    ...
    .detailed-cell--price { width: 140px; }
    ...
    .detailed-interval { font-size: 12px; color: #888; }
